...
(function ($) {
  ...
  var Gritter = {
    ...
    add: function (params) {
      ...
      var item_class = params.class_name || $.gritter.options.class_name
      var position = $.gritter.options.position
    ...
    _str_replace: function (search, replace, subject, count) {
      var i = 0; var j = 0; var temp = ''; var repl = ''; var sl = 0; var fl = 0
      var f = [].concat(search)
      var r = [].concat(replace)
      var s = subject
      var ra = r instanceof Array; var sa = s instanceof Array
      s = [].concat(s)
